...
public class AdbHelp4FProgressDialog extends FProgressDialog implements FProgressDialog.OnFProgressDialogListener {
    private static final String TAG = "Adb4FProgressDialog";
    private final AdbActivity adbActivity;

    public AdbHelp4FProgressDialog(AdbActivity adbActivity) {
        super(adbActivity);
        this.setOnFProgressDialogListener(this);
        this.adbActivity = adbActivity;
    }
